...
T_END = result(:, 7);
Z23 = result(:, 8);
result_table = table(drive_1, drive_2, drive_3, drive_4, ...
    T_TOP, T_MID, T_END, Z23);
writetable(result_table, '.\data_output\table_displace_23.csv');
